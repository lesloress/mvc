    ...
    public class BlogDbInitializer : DropCreateDatabaseIfModelChanges<BlogContext>
    {
        protected override void Seed(BlogContext context)
        {
            ...
            { 
                ...
                Annotation = "Еще один шрифт или «цвет года» — визуальные тренды год от года меняются лишь косметически. " +
                "Но в дизайне происходят более глубинные перемены.",
            ...
            defaultArticles.Add(new Article()
            {
                ...
                Annotation = "Пока другие именитые дизайнеры создавали малопригодные для жизни интерьерные арт-объекты, сэр Теренс Конран ставил на первое место удобство. Посвященный в рыцари за заслуги в области дизайна, Конран оказал влияние на весь британский быт и стиль жизни. Узнаем, каким видит современный интерьер один из самых влиятельных дизайнеров в мире.",
                Date = DateTime.Now.Date
            });
